...
export default function ForgotPasswordPage() {
  ...
  const handleSubmitEmail = async () => {
    ...
    try {
      ...
      setError(
        e?.response?.data?.message || "Email not found. Please try again.",
      );
    } finally {
      setLoading(false);
    }
        ...
        <Box sx={{ p: 4 }}>
          ...
          {step === "email" && (
            <Box sx={{ display: "flex", flexDirection: "column", gap: 0.5 }}>
              ...
              >
                {loading ? (
                  <CircularProgress size={24} sx={{ color: C.ink }} />
                ) : (
            ...
            >
                ...
                {otp.map((digit, i) => (
                  <Box
                    ...
                    sx={{
                      ...
                      fontSize: "1.5rem",
                      fontWeight: 600,
                      border: `2px solid ${digit ? C.yellowDark : C.border}`,
                      borderRadius: "12px",
                      outline: "none",
                      background: digit ? C.yellowLight : C.white,
              ...
              <Box sx={{ textAlign: "center" }}>
                {canResend ? (
                  ...
                  <Typography sx={{ color: C.inkLight, fontSize: "0.85rem" }}>
                    Resend code in{" "}
                    <strong style={{ color: C.yellowDark }}>
                      {resendTimer}s
                    </strong>
                  </Typography>
                )}
