            ...
            <Box sx={{ maxWidth: { xs: "100%", sm: "500px", md: "40em" }, mx: "auto", px: { xs: 2, sm: 3, md: 8 } }}>
              ...
              <form onSubmit={handleSubmit}>
                <Grid container spacing={{ xs: 2, md: 4 }} sx={{ width: "100%" }}>
                  <Grid size={6}>
                    <Typography variant="subtitle1" sx={{ mb: 1, fontWeight: 600, fontSize: { xs: "0.875rem", md: "1rem" } }}>
                      First Name
                    </Typography>
                    <TextField
                      fullWidth
                  ...
                  InputProps={{
                    endAdornment: (
                      <InputAdornment position="end">
                        <IconButton onClick={() => setShowPassword(!showPassword)} edge="end" sx={{ p: { xs: 0.5, md: 1 } }}>
                ...
                <Box sx={{ display: "flex", justifyContent: "flex-end", mb: { xs: 1, md: 1.5 } }}>
                  <Link href="/forgot-password" underline="hover" sx={{ color: "text.primary", fontSize: { xs: "0.875rem", md: "1rem" }, fontWeight: 600 }}>
                    Forgot Password?
                  </Link>
                </Box>
